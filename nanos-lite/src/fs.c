...
static Finfo file_table[] __attribute__((used)) = {
  {"stdin", 0, 0, (ReadFn) invalid_read, (WriteFn) invalid_write},
  {"stdout", 0, 0, (ReadFn) invalid_read, (WriteFn) invalid_write},
  {"stderr", 0, 0, (ReadFn) invalid_read, (WriteFn) invalid_write},
#include "files.h"
};
